...
static func setup() -> void:
	...
	_act("p1_special", [KEY_SPACE], [JOY_BUTTON_B, JOY_BUTTON_X, JOY_BUTTON_Y,
		JOY_BUTTON_RIGHT_SHOULDER], 0)
	_act("p1_down", [KEY_S], [JOY_BUTTON_DPAD_DOWN, JOY_BUTTON_LEFT_SHOULDER], 0,
		JOY_AXIS_LEFT_Y, 1)
	...
	_act("p2_special", [KEY_SHIFT, KEY_KP_0], [JOY_BUTTON_B, JOY_BUTTON_X,
		JOY_BUTTON_Y, JOY_BUTTON_RIGHT_SHOULDER], 1)
	_act("p2_down", [KEY_DOWN], [JOY_BUTTON_DPAD_DOWN, JOY_BUTTON_LEFT_SHOULDER], 1,
		JOY_AXIS_LEFT_Y, 1)
	...
	_act("solo_special", [KEY_SPACE], [JOY_BUTTON_B, JOY_BUTTON_X, JOY_BUTTON_Y,
		JOY_BUTTON_RIGHT_SHOULDER], PAD_ANY)
	_act("solo_down", [KEY_S, KEY_DOWN], [JOY_BUTTON_DPAD_DOWN,
		JOY_BUTTON_LEFT_SHOULDER], PAD_ANY, JOY_AXIS_LEFT_Y, 1)
