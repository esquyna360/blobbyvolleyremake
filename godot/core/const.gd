...
const DIVE_RECOVER := 36
const DIVE_WINDUP := 4
const BONK_FRAMES := 48
const BONK_SPEED := BLOBBY_SPEED * 1.6
const BONK_BOUNCE := 2.4
const BLOCK_REACH := 70.0
const BLOCK_WINDOW := 16
const BLOCK_OVER := 34.0
const BLOCK_SPEED := 13.5
const BLOCK_HANG := 18
const BLOCK_HANG_G := 0.35
const DIVE_CD := 52
