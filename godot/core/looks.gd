...
const BODY_COLORS := [
	{"id": "rosa", "name": "Pink", "hex": "#F07FBB"},
	{"id": "lima", "name": "Lime", "hex": "#B8E05C"},
	{"id": "coral", "name": "Coral", "hex": "#FF9A6B"},
	{"id": "menta", "name": "Mint", "hex": "#6FD9A8"},
	{"id": "lavanda", "name": "Lavender", "hex": "#A47DFF"},
	{"id": "creme", "name": "Cream", "hex": "#F0E2C0"},
	{"id": "ciano", "name": "Cyan", "hex": "#63C8E8"},
	{"id": "ambar", "name": "Amber", "hex": "#F5C451"},
]

const PAIR_MIN_LUMA := 30.0

const HAIR_COLORS := [
	{"id": "preto", "name": "Black", "hex": "#221d2a"},
	{"id": "castanho", "name": "Brown", "hex": "#6b4326"},
	{"id": "loiro", "name": "Blonde", "hex": "#e8c66a"},
	{"id": "ruivo", "name": "Ginger", "hex": "#d1522a"},
	{"id": "branco", "name": "White", "hex": "#f0f3f8"},
	{"id": "prata", "name": "Silver", "hex": "#aab6c9"},
	{"id": "rosa", "name": "Pink", "hex": "#ff6fb5"},
	{"id": "azul", "name": "Blue", "hex": "#4aa8ff"},
	{"id": "verde", "name": "Green", "hex": "#3ec46e"},
	{"id": "roxo", "name": "Purple", "hex": "#a06bff"},
]
