...
// web/node_modules/.pnpm/mqtt@5.15.2/node_modules/mqtt/dist/mqtt.esm.js
...
var N = {};
Kr(N, { _debugEnd: () => Qc, _debugProcess: () => Kc, _events: () => hf, _eventsCount: () => df, _exiting: () => Oc, _fatalExceptions: () => Hc, _getActiveHandles: () => Bc, _getActiveRequests: () => Cc, _kill: () => Nc, _linkedBinding: () => Tc, _maxListeners: () => ff, _preload_modules: () => uf, _rawDebug: () => Ic, _startProfilerIdleNotifier: () => Yc, _stopProfilerIdleNotifier: () => Jc, _tickCallback: () => zc, abort: () => tf, addListener: () => pf, allowedNodeEnvironmentFlags: () => Fc, arch: () => fc, argv: () => pc, argv0: () => af, assert: () => Wc, binding: () => mc, browser: () => Ac, chdir: () => Sc, config: () => Rc, cpuUsage: () => Ri, cwd: () => vc, debugPort: () => sf, default: () => Ef, dlopen: () => kc, domain: () => Pc, emit: () => mf, emitWarning: () => wc, env: () => dc, execArgv: () => yc, execPath: () => of, exit: () => Dc, features: () => $c, hasUncaughtExceptionCaptureCallback: () => Gc, hrtime: () => Oi, kill: () => Uc, listeners: () => Sf, memoryUsage: () => Lc, moduleLoadList: () => xc, nextTick: () => uc, off: () => gf, on: () => Nt, once: () => yf, openStdin: () => jc, pid: () => rf, platform: () => hc, ppid: () => nf, prependListener: () => _f, prependOnceListener: () => vf, reallyExit: () => Mc, release: () => Ec, removeAllListeners: () => wf, removeListener: () => bf, resourceUsage: () => qc, setSourceMapsEnabled: () => lf, setUncaughtExceptionCaptureCallback: () => Vc, stderr: () => Zc, stdin: () => ef, stdout: () => Xc, title: () => cc, umask: () => _c, uptime: () => cf, version: () => gc, versions: () => bc });
function cs(t) {
  throw new Error("Node.js process " + t + " is not supported by JSPM core outside of Node.js");
}
function ew() {
  !Qr || !wr || (Qr = false, wr.length ? Mt = wr.concat(Mt) : Pi = -1, Mt.length && ac());
}
function ac() {
  if (!Qr) {
...
var Af = ze(() => {
  ...
  cc = "browser", fc = "x64", hc = "browser", dc = { PATH: "/usr/bin", LANG: typeof navigator < "u" ? navigator.language + ".UTF-8" : void 0, PWD: "/", HOME: "/home", TMP: "/tmp" }, pc = ["/usr/bin/node"], yc = [], gc = "v16.8.0", bc = {}, wc = function(t, e) {
    console.warn((e ? e + ": " : "") + t);
  }, mc = function(t) {
    cs("binding");
  }, _c = function(t) {
  ...
  Ac = true, Ic = Ue, xc = [];
  Pc = {}, Oc = false, Rc = {};
  Mc = Ue, Nc = Ue, Ri = function() {
    return {};
  }, qc = Ri, Lc = Ri, Uc = Ue, Dc = Ue, jc = Ue, Fc = {};
  $c = { inspector: false, debug: false, uv: false, ipv6: false, tls_alpn: false, tls_sni: false, tls_ocsp: false, tls: false, cached_builtins: true }, Hc = Ue, Vc = Ue;
  zc = Ue, Kc = Ue, Qc = Ue, Yc = Ue, Jc = Ue, Xc = void 0, Zc = void 0, ef = void 0, tf = Ue, rf = 2, nf = 1, of = "/bin/usr/node", sf = 9229, af = "node", uf = [], lf = Ue, Jt = { now: typeof performance < "u" ? performance.now.bind(performance) : void 0, timing: typeof performance < "u" ? performance.timing : void 0 };
  ...
  ff = 10, hf = {}, df = 0;
  pf = Nt, yf = Nt, gf = Nt, bf = Nt, wf = Nt, mf = Ue, _f = Nt, vf = Nt;
  Ef = { version: gc, versions: bc, arch: fc, platform: hc, browser: Ac, release: Ec, _rawDebug: Ic, moduleLoadList: xc, binding: mc, _linkedBinding: Tc, _events: hf, _eventsCount: df, _maxListeners: ff, on: Nt, addListener: pf, once: yf, off: gf, removeListener: bf, removeAllListeners: wf, emit: mf, prependListener: _f, prependOnceListener: vf, listeners: Sf, domain: Pc, _exiting: Oc, config: Rc, dlopen: kc, uptime: cf, _getActiveRequests: Cc, _getActiveHandles: Bc, reallyExit: Mc, _kill: Nc, cpuUsage: Ri, resourceUsage: qc, memoryUsage: Lc, kill: Uc, exit: Dc, openStdin: jc, allowedNodeEnvironmentFlags: Fc, assert: Wc, features: $c, _fatalExceptions: Hc, setUncaughtExceptionCaptureCallback: Vc, hasUncaughtExceptionCaptureCallback: Gc, emitWarning: wc, nextTick: uc, _tickCallback: zc, _debugProcess: Kc, _debugEnd: Qc, _startProfilerIdleNotifier: Yc, _stopProfilerIdleNotifier: Jc, stdout: Xc, stdin: ef, stderr: Zc, abort: tf, umask: _c, chdir: Sc, cwd: vc, env: dc, title: cc, argv: pc, execArgv: yc, pid: rf, ppid: nf, execPath: of, debugPort: sf, hrtime: Oi, argv0: af, _preload_modules: uf, setSourceMapsEnabled: lf };
});
var I = ze(() => {
  Af();
});
function tw() {
  if (If) return On;
  If = true, On.byteLength = a, On.toByteArray = f, On.fromByteArray = m;
...
`;
  ...
  Rf.exports = { AggregateError: fs, ArrayIsArray(t) {
...
var De = j((tO, Mf) => {
  ...
  Mf.exports = { AbortError: ds, aggregateTwoErrors: Bf(dw), hideStackFrames: Bf, codes: Bi };
});
var Yr = j((fO, Mi) => {
  "use strict";
  A();
  x();
  I();
  var { AbortController: Nf, AbortSignal: pw } = typeof self < "u" ? self : typeof window < "u" ? window : void 0;
  Mi.exports = Nf;
...
var $e = j((RO, ys) => {
  ...
  }).constructor, Lf = globalThis.Blob || Sw.Blob, kw = typeof Lf < "u" ? function(e) {
  ...
  ys.exports = { AggregateError: xw, kEmptyObject: Object.freeze({}), once(t) {
    ...
    return e.forEach((i) => {
      Uf(i, "signals"), i.addEventListener("abort", n, { once: true });
...
var Xr = j((jO, Kf) => {
  ...
  x();
  I();
  var { ArrayIsArray: bs, ArrayPrototypeIncludes: Wf, ArrayPrototypeJoin: $f, ArrayPrototypeMap: Bw, NumberIsInteger: ws, NumberIsNaN: Mw, NumberMAX_SAFE_INTEGER: Nw, NumberMIN_SAFE_INTEGER: qw, NumberParseInt: Lw, ObjectPrototypeHasOwnProperty: Uw, RegExpPrototypeExec: Hf, String: Dw, StringPrototypeToUpperCase: jw, StringPrototypeTrim: Fw } = Ee(), { hideStackFrames: et, codes: { ERR_SOCKET_BAD_PORT: Ww, ERR_INVALID_ARG_TYPE: je, ERR_INVALID_ARG_VALUE: Jr, ERR_OUT_OF_RANGE: vr, ERR_UNKNOWN_SIGNAL: Df } } = De(), { normalizeEncoding: $w } = $e(), { isAsyncFunction: Hw, isArrayBufferView: Vw } = $e().types, jf = {};
  function Gw(t) {
    return t === (t | 0);
  }
  function zw(t) {
  ...
  var em = et((t, e, r) => {
    if (!Wf(r, t)) {
      let i = "must be one of: " + $f(Bw(r, (s) => typeof s == "string" ? `'${s}'` : Dw(s)), ", ");
      throw new Jr(e, t, i);
    }
  });
  function Gf(t, e) {
  ...
  function sm(t, e = "signal") {
    if (ms(t, e), jf[t] === void 0) throw jf[jw(t)] !== void 0 ? new Df(t + " (signals must use all capital letters)") : new Df(t);
  }
  ...
  var pm = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
  function Ff(t, e) {
    if (typeof t > "u" || !Hf(pm, t)) throw new Jr(e, t, 'must be an array or string of format "</styles.css>; rel=preload; as=style"');
  }
  function ym(t) {
  ...
  Kf.exports = { isInt32: Gw, isUint32: zw, parseFileMode: Yw, validateArray: qi, validateStringArray: nm, validateBooleanArray: im, validateAbortSignalArray: om, validateBoolean: Gf, validateBuffer: am, validateDictionary: rm, validateEncoding: um, validateFunction: cm, validateInt32: Xw, validateInteger: Jw, validateNumber: Zw, validateObject: tm, validateOneOf: em, validatePlainFunction: fm, validatePort: lm, validateSignalName: sm, validateString: ms, validateUint32: Vf, validateUndefined: hm, validateUnion: dm, validateAbortSignal: zf, validateLinkHeaderValue: ym };
});
var tr = j((YO, Xf) => {
  A();
  x();
  I();
  var Te = Xf.exports = {}, gt, bt;
  function _s() {
  ...
  function bm() {
    !Zr || !Sr || (Zr = false, Sr.length ? qt = Sr.concat(qt) : Li = -1, qt.length && Yf());
  }
  function Yf() {
    if (!Zr) {
      var t = Qf(bm);
...
var mt = j((sR, dh) => {
  ...
  x();
  I();
  var { SymbolAsyncIterator: Zf, SymbolIterator: eh, SymbolFor: Er } = Ee(), th = Er("nodejs.stream.destroyed"), rh = Er("nodejs.stream.errored"), Ss = Er("nodejs.stream.readable"), Es = Er("nodejs.stream.writable"), nh = Er("nodejs.stream.disturbed"), wm = Er("nodejs.webstream.isClosedPromise"), mm = Er("nodejs.webstream.controllerErrorFunction");
  ...
  function Sm(t, e) {
    return t == null ? false : e === true ? typeof t[Zf] == "function" : e === false ? typeof t[eh] == "function" : typeof t[Zf] == "function" || typeof t[eh] == "function";
  }
  function ji(t) {
    if (!wt(t)) return null;
  ...
  function lh(t) {
    return t && t[Ss] != null ? t[Ss] : typeof t?.readable != "boolean" ? null : ji(t) ? false : Ui(t) && t.readable && !uh(t);
  }
  function ch(t) {
    return t && t[Es] != null ? t[Es] : typeof t?.writable != "boolean" ? null : ji(t) ? false : Di(t) && t.writable && !ah(t);
  }
  function Im(t, e) {
    return wt(t) ? ji(t) ? true : !(e?.readable !== false && lh(t) || e?.writable !== false && ch(t)) : null;
  }
  function xm(t) {
    var e, r;
  ...
  function Pm(t) {
    ...
    return typeof e?.closed == "boolean" || typeof r?.closed == "boolean" ? e?.closed || r?.closed : typeof t._closed == "boolean" && fh(t) ? t._closed : null;
  }
  function fh(t) {
  ...
  function Rm(t) {
    if (!wt(t)) return null;
    let e = t._writableState, r = t._readableState, n = e || r;
    return !n && hh(t) || !!(n && n.autoDestroy && n.emitClose && n.closed === false);
  }
  function km(t) {
    var e;
    return !!(t && ((e = t[nh]) !== null && e !== void 0 ? e : t.readableDidRead || t.readableAborted));
  }
  function Cm(t) {
    var e, r, n, i, s, o, a, c, f, h;
    return !!(t && ((e = (r = (n = (i = (s = (o = t[rh]) !== null && o !== void 0 ? o : t.readableErrored) !== null && s !== void 0 ? s : t.writableErrored) !== null && i !== void 0 ? i : (a = t._readableState) === null || a === void 0 ? void 0 : a.errorEmitted) !== null && n !== void 0 ? n : (c = t._writableState) === null || c === void 0 ? void 0 : c.errorEmitted) !== null && r !== void 0 ? r : (f = t._readableState) === null || f === void 0 ? void 0 : f.errored) !== null && e !== void 0 ? e : !((h = t._writableState) === null || h === void 0) && h.errored));
  }
  dh.exports = { isDestroyed: ji, kIsDestroyed: th, isDisturbed: km, kIsDisturbed: nh, isErrored: Cm, kIsErrored: rh, isReadable: lh, kIsReadable: Ss, kIsClosedPromise: wm, kControllerErrorFunction: mm, kIsWritable: Es, isClosed: Pm, isDuplexNodeStream: _m, isFinished: Im, isIterable: Sm, isReadableNodeStream: Ui, isReadableStream: ih, isReadableEnded: Am, isReadableFinished: uh, isReadableErrored: Tm, isNodeStream: wt, isWebStream: vm, isWritable: ch, isWritableNodeStream: Di, isWritableStream: oh, isWritableEnded: ah, isWritableFinished: Em, isWritableErrored: xm, isServerRequest: Om, isServerResponse: hh, willEmitClose: Rm, isTransformStream: sh };
});
var Ut = j((gR, Ps) => {
  "use strict";
  A();
  x();
  I();
  var rr = tr(), { AbortError: Sh, codes: Bm } = De(), { ERR_INVALID_ARG_TYPE: Mm, ERR_STREAM_PREMATURE_CLOSE: ph } = Bm, { kEmptyObject: Is, once: xs } = $e(), { validateAbortSignal: Nm, validateFunction: qm, validateObject: Lm, validateBoolean: Um } = Xr(), { Promise: Dm, PromisePrototypeThen: jm, SymbolDispose: Eh } = Ee(), { isClosed: Fm, isReadable: yh, isReadableNodeStream: As, isReadableStream: Wm, isReadableFinished: gh, isReadableErrored: bh, isWritable: wh, isWritableNodeStream: mh, isWritableStream: $m, isWritableFinished: _h, isWritableErrored: vh, isNodeStream: Hm, willEmitClose: Vm, kIsClosedPromise: Gm } = mt(), en;
  function zm(t) {
  ...
  function Ah(t, e, r) {
    ...
    let s = (n = e.readable) !== null && n !== void 0 ? n : As(t), o = (i = e.writable) !== null && i !== void 0 ? i : mh(t), a = t._writableState, c = t._readableState, f = () => {
      t.writable || m();
    }, h = Vm(t) && As(t) === s && mh(t) === o, d = _h(t, false), m = () => {
      ...
      if (s && !g && As(t, true) && !gh(t, false)) return r.call(t, new ph());
      if (o && !d && !_h(t, false)) return r.call(t, new ph());
      r.call(t);
    }, _ = () => {
      b = true;
      let y = vh(t) || bh(t);
  ...
  function Km(t, e, r) {
    let n = false, i = Ts;
    if (e.signal) if (i = () => {
      n = true, r.call(t, new Sh(void 0, { cause: e.signal.reason }));
...
var Ar = j((xR, Ch) => {
  ...
  x();
  I();
  var _t = tr(), { aggregateTwoErrors: Ym, codes: { ERR_MULTIPLE_CALLBACK: Jm }, AbortError: Xm } = De(), { Symbol: Th } = Ee(), { kIsDestroyed: Zm, isDestroyed: e_, isFinished: t_, isServerRequest: r_ } = mt(), Ph = Th("kDestroy"), Os = Th("kConstruct");
  function Oh(t, e, r) {
    t && (t.stack, e && !e.errored && (e.errored = t), r && !r.errored && (r.errored = t));
  }
  function n_(t, e) {
    let r = this._readableState, n = this._writableState, i = n || r;
    return n != null && n.destroyed || r != null && r.destroyed ? (typeof e == "function" && e(), this) : (Oh(t, n, r), n && (n.destroyed = true), r && (r.destroyed = true), i.constructed ? Ih(this, t, e) : this.once(Ph, function(s) {
      Ih(this, Ym(s, t), e);
    }), this);
  }
  function Ih(t, e, r) {
    ...
    function i(s) {
      ...
      Oh(s, a, o), a && (a.closed = true), o && (o.closed = true), typeof r == "function" && r(s), s ? _t.nextTick(i_, t, s) : _t.nextTick(Rh, t);
    }
    try {
      t._destroy(e || null, i);
    } catch (s) {
  ...
  function a_(t) {
    ...
    function r(n) {
      ...
      i && (i.constructed = true), s && (s.constructed = true), o.destroyed ? t.emit(Ph, n) : n ? ks(t, n, true) : _t.nextTick(u_, t);
    }
    try {
      t._construct((n) => {
        _t.nextTick(r, n);
  ...
  function c_(t, e) {
    !t || e_(t) || (!e && !t_(t) && (e = new Xm()), r_(t) ? (t.socket = null, t.destroy(e)) : xh(t) ? t.abort() : xh(t.req) ? t.req.abort() : typeof t.destroy == "function" ? t.destroy(e) : typeof t.close == "function" ? t.close() : e ? _t.nextTick(l_, t, e) : _t.nextTick(kh, t), t.destroyed || (t[Zm] = true));
  }
  Ch.exports = { construct: s_, destroyer: c_, destroy: n_, undestroy: o_, errorOrDestroy: ks };
});
var $i = j((qR, Mh) => {
  "use strict";
  A();
  x();
  I();
  var { ArrayIsArray: f_, ObjectSetPrototypeOf: Bh } = Ee(), { EventEmitter: Fi } = (er(), me(Zt));
  function Wi(t) {
    Fi.call(this, t);
  }
...
var kn = j((GR, Hi) => {
  ...
  x();
  I();
  var { SymbolDispose: h_ } = Ee(), { AbortError: Nh, codes: d_ } = De(), { isNodeStream: qh, isWebStream: p_, kControllerErrorFunction: y_ } = mt(), g_ = Ut(), { ERR_INVALID_ARG_TYPE: Lh } = d_, Bs, b_ = (t, e) => {
    if (typeof t != "object" || !("aborted" in t)) throw new Lh(e, "AbortSignal", t);
  };
  Hi.exports.addAbortSignal = function(e, r) {
    if (b_(e, "signal"), !qh(r) && !p_(r)) throw new Lh("stream", ["ReadableStream", "WritableStream", "Stream"], r);
...
var jh = j((nk, Dh) => {
  ...
  x();
  I();
  var { StringPrototypeSlice: Uh, SymbolIterator: w_, TypedArrayPrototypeSet: Vi, Uint8Array: m_ } = Ee(), { Buffer: Ms } = (ke(), me(qe)), { inspect: __ } = $e();
  Dh.exports = class {
    constructor() {
    ...
    _getString(e) {
      ...
      do {
        ...
        if (e > s.length) r += s, e -= s.length;
          ...
          e === s.length ? (r += s, ++i, n.next ? this.head = n.next : this.head = this.tail = null) : (r += Uh(s, 0, e), this.head = n, n.data = Uh(s, e));
          break;
        }
        ++i;
      } while ((n = n.next) !== null);
...
var Cn = j((dk, Hh) => {
  ...
  x();
  I();
  var { MathFloor: v_, NumberIsInteger: S_ } = Ee(), { validateInteger: E_ } = Xr(), { ERR_INVALID_ARG_VALUE: A_ } = De().codes, Fh = 16 * 1024, Wh = 16;
  function I_(t, e, r) {
  ...
  Hh.exports = { getHighWaterMark: T_, getDefaultHighWaterMark: $h, setDefaultHighWaterMark: x_ };
});
var zh = j((Ns, Gh) => {
  A();
  x();
  ...
  vt.from && vt.alloc && vt.allocUnsafe && vt.allocUnsafeSlow ? Gh.exports = Gi : (Vh(Gi, Ns), Ns.Buffer = Ir);
  function Ir(t, e, r) {
    return vt(t, e, r);
  }
...
var Yh = j((Qh) => {
  ...
  x();
  I();
  var Ls = zh().Buffer, Kh = Ls.isEncoding || function(t) {
  ...
  function O_(t) {
    var e = P_(t);
    if (typeof e != "string" && (Ls.isEncoding === Kh || !Kh(t))) throw new Error("Unknown encoding: " + t);
    return e || t;
  }
  Qh.StringDecoder = Bn;
  function Bn(t) {
...
var Us = j((Wk, ed) => {
  ...
  x();
  I();
  var Jh = tr(), { PromisePrototypeThen: F_, SymbolAsyncIterator: Xh, SymbolIterator: Zh } = Ee(), { Buffer: W_ } = (ke(), me(qe)), { ERR_INVALID_ARG_TYPE: $_, ERR_STREAM_NULL_VALUES: H_ } = De().codes;
  function V_(t, e, r) {
    let n;
...
var Nn = j((Xk, wd) => {
  ...
  x();
  I();
  var lt = tr(), { ArrayPrototypeIndexOf: G_, NumberIsInteger: z_, NumberIsNaN: K_, NumberParseInt: Q_, ObjectDefineProperties: Gs, ObjectKeys: Y_, ObjectSetPrototypeOf: nd, Promise: id, SafeSet: J_, SymbolAsyncDispose: X_, SymbolAsyncIterator: Z_, Symbol: ev } = Ee();
  wd.exports = le;
  le.ReadableState = Yi;
  var { EventEmitter: tv } = (er(), me(Zt)), { Stream: nr, prependListener: rv } = $i(), { Buffer: Ds } = (ke(), me(qe)), { addAbortSignal: nv } = kn(), od = Ut(), de = $e().debuglog("stream", (t) => {
    de = t;
  }), iv = jh(), nn = Ar(), { getHighWaterMark: ov, getDefaultHighWaterMark: sv } = Cn(), { aggregateTwoErrors: td, codes: { ERR_INVALID_ARG_TYPE: av, ERR_METHOD_NOT_IMPLEMENTED: uv, ERR_OUT_OF_RANGE: lv, ERR_STREAM_PUSH_AFTER_EOF: cv, ERR_STREAM_UNSHIFT_AFTER_END_EVENT: fv }, AbortError: hv } = De(), { validateObject: dv } = Xr(), xr = ev("kPaused"), { StringDecoder: sd } = Yh(), pv = Us();
  nd(le.prototype, nr.prototype);
  nd(le, nr);
  var js = () => {
  }, { errorOrDestroy: tn } = nn, rn = 1, yv = 2, ad = 4, Mn = 8, ud = 16, zi = 32, Ki = 64, ld = 128, gv = 256, bv = 512, wv = 1024, Hs = 2048, Vs = 4096, mv = 8192, _v = 16384, vv = 32768, cd = 65536, Sv = 1 << 17, Ev = 1 << 18;
  function Ce(t) {
  ...
  Gs(Yi.prototype, { objectMode: Ce(rn), ended: Ce(yv), endEmitted: Ce(ad), reading: Ce(Mn), constructed: Ce(ud), sync: Ce(zi), needReadable: Ce(Ki), emittedReadable: Ce(ld), readableListening: Ce(gv), resumeScheduled: Ce(bv), errorEmitted: Ce(wv), emitClose: Ce(Hs), autoDestroy: Ce(Vs), destroyed: Ce(mv), closed: Ce(_v), closeEmitted: Ce(vv), multiAwaitDrain: Ce(cd), readingMore: Ce(Sv), dataEmitted: Ce(Ev) });
  function Yi(t, e, r) {
    typeof r != "boolean" && (r = e instanceof St()), this.state = Hs | Vs | ud | zi, t && t.objectMode && (this.state |= rn), r && t && t.readableObjectMode && (this.state |= rn), this.highWaterMark = t ? ov(this, t, "readableHighWaterMark", r) : sv(false), this.buffer = new iv(), this.length = 0, this.pipes = [], this.flowing = null, this[xr] = null, t && t.emitClose === false && (this.state &= ~Hs), t && t.autoDestroy === false && (this.state &= ~Vs), this.errored = null, this.defaultEncoding = t && t.defaultEncoding || "utf8", this.awaitDrainWriters = null, this.decoder = null, this.encoding = null, t && t.encoding && (this.decoder = new sd(t.encoding), this.encoding = t.encoding);
  }
  function le(t) {
  ...
  le.prototype[X_] = function() {
    let t;
    return this.destroyed || (t = this.readableEnded ? null : new hv(), this.destroy(t)), new id((e, r) => od(this, (n) => n && n !== t ? r(n) : e(null)));
  };
  le.prototype.push = function(t, e) {
    return fd(this, t, e, false);
  };
  le.prototype.unshift = function(t, e) {
    return fd(this, t, e, true);
  };
  function fd(t, e, r, n) {
    ...
    else if ((i.state & rn) !== 0 || e && e.length > 0) if (n) if ((i.state & ad) !== 0) tn(t, new fv());
    else {
  ...
  function Fs(t, e, r, n) {
    e.flowing && e.length === 0 && !e.sync && t.listenerCount("data") > 0 ? ((e.state & cd) !== 0 ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null, e.dataEmitted = true, t.emit("data", r)) : (e.length += e.objectMode ? 1 : r.length, n ? e.buffer.unshift(r) : e.buffer.push(r), (e.state & Ki) !== 0 && Ji(t)), Qi(t, e);
  }
  ...
  le.prototype.read = function(t) {
    ...
    if (t > e.highWaterMark && (e.highWaterMark = Iv(t)), t !== 0 && (e.state &= ~ld), t === 0 && e.needReadable && ((e.highWaterMark !== 0 ? e.length >= e.highWaterMark : e.length > 0) || e.ended)) return de("read: emitReadable", e.length, e.ended), e.length === 0 && e.ended ? Ws(this) : Ji(this), null;
    if (t = rd(t, e), t === 0 && e.ended) return e.length === 0 && Ws(this), null;
    let n = (e.state & Ki) !== 0;
    ...
    let i;
    return t > 0 ? i = gd(t, e) : i = null, i === null ? (e.needReadable = e.length <= e.highWaterMark, t = 0) : (e.length -= t, e.multiAwaitDrain ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null), e.length === 0 && (e.ended || (e.needReadable = true), r !== t && e.ended && Ws(this)), i !== null && !e.errorEmitted && !e.closeEmitted && (e.dataEmitted = true, this.emit("data", i)), i;
  };
  function xv(t, e) {
    if (de("onEofChunk"), !e.ended) {
      ...
      e.ended = true, e.sync ? Ji(t) : (e.needReadable = false, e.emittedReadable = true, hd(t));
    }
  }
  function Ji(t) {
    let e = t._readableState;
    de("emitReadable", e.needReadable, e.emittedReadable), e.needReadable = false, e.emittedReadable || (de("emitReadable", e.flowing), e.emittedReadable = true, lt.nextTick(hd, t));
  }
  function hd(t) {
    let e = t._readableState;
    de("emitReadable_", e.destroyed, e.length, e.ended), !e.destroyed && !e.errored && (e.length || e.ended) && (t.emit("readable"), e.emittedReadable = false), e.needReadable = !e.flowing && !e.ended && e.length <= e.highWaterMark, pd(t);
  }
  function Qi(t, e) {
  ...
  function kv(t, e) {
    de("resume", e.reading), e.reading || t.read(0), e.resumeScheduled = false, t.emit("resume"), pd(t), e.flowing && !e.reading && t.read(0);
  }
...
var ro = j((uC, Rd) => {
  ...
  x();
  I();
  var Tr = tr(), { ArrayPrototypeSlice: vd, Error: Nv, FunctionPrototypeSymbolHasInstance: Sd, ObjectDefineProperty: Ed, ObjectDefineProperties: qv, ObjectSetPrototypeOf: Ad, StringPrototypeToLowerCase: Lv, Symbol: Uv, SymbolHasInstance: Dv } = Ee();
  Rd.exports = Ie;
  Ie.WritableState = Un;
  var { EventEmitter: jv } = (er(), me(Zt)), qn = $i().Stream, { Buffer: Xi } = (ke(), me(qe)), to = Ar(), { addAbortSignal: Fv } = kn(), { getHighWaterMark: Wv, getDefaultHighWaterMark: $v } = Cn(), { ERR_INVALID_ARG_TYPE: Hv, ERR_METHOD_NOT_IMPLEMENTED: Vv, ERR_MULTIPLE_CALLBACK: Id, ERR_STREAM_CANNOT_PIPE: Gv, ERR_STREAM_DESTROYED: Ln, ERR_STREAM_ALREADY_FINISHED: zv, ERR_STREAM_NULL_VALUES: Kv, ERR_STREAM_WRITE_AFTER_END: Qv, ERR_UNKNOWN_ENCODING: xd } = De().codes, { errorOrDestroy: on } = to;
  ...
  Ed(Un.prototype, "bufferedRequestCount", { __proto__: null, get() {
  ...
  Ed(Ie, Dv, { __proto__: null, value: function(t) {
    return Sd(this, t) ? true : this !== Ie ? false : t && t._writableState instanceof Un;
  } });
  ...
  Ie.prototype.setDefaultEncoding = function(e) {
    if (typeof e == "string" && (e = Lv(e)), !Xi.isEncoding(e)) throw new xd(e);
  ...
  function Jv(t, e) {
    ...
    r.writing = false, r.writecb = null, r.length -= r.writelen, r.writelen = 0, e ? (e.stack, r.errored || (r.errored = e), t._readableState && !t._readableState.errored && (t._readableState.errored = e), n ? Tr.nextTick(_d, t, r, e, i) : _d(t, r, e, i)) : (r.buffered.length > r.bufferedIndex && Js(t, r), n ? r.afterWriteTickInfo !== null && r.afterWriteTickInfo.cb === i ? r.afterWriteTickInfo.count++ : (r.afterWriteTickInfo = { count: 1, cb: i, stream: t, state: r }, Tr.nextTick(Xv, r.afterWriteTickInfo)) : Pd(t, r, 1, i));
  }
  ...
  function Js(t, e) {
    ...
    if (e.bufferProcessing = true, s > 1 && t._writev) {
      ...
      c.allBuffers = e.allBuffers, md(t, e, true, e.length, c, "", a), eo(e);
    } else {
      do {
        let { chunk: a, encoding: c, callback: f } = r[o];
        r[o++] = null;
        let h = i ? 1 : a.length;
        md(t, e, false, h, a, c, f);
...
var Vd = j((wC, Hd) => {
  ...
  x();
  I();
  var Zs = tr(), r0 = (ke(), me(qe)), { isReadable: n0, isWritable: i0, isIterable: kd, isNodeStream: o0, isReadableNodeStream: Cd, isWritableNodeStream: Bd, isDuplexNodeStream: s0, isReadableStream: Md, isWritableStream: Nd } = mt(), qd = Ut(), { AbortError: Wd, codes: { ERR_INVALID_ARG_TYPE: a0, ERR_INVALID_RETURN_VALUE: Ld } } = De(), { destroyer: un } = Ar(), u0 = St(), $d = Nn(), l0 = ro(), { createDeferredPromise: Ud } = $e(), Dd = Us(), jd = globalThis.Blob || r0.Blob, c0 = typeof jd < "u" ? function(e) {
    return e instanceof jd;
  } : function(e) {
    return false;
  }, f0 = globalThis.AbortController || Yr().AbortController, { FunctionPrototypeCall: Fd } = Ee(), ir = class extends u0 {
    constructor(e) {
  ...
  Hd.exports = function t(e, r) {
    ...
    if (typeof e == "function") {
      ...
      if (kd(i)) return Dd(ir, i, { objectMode: true, write: s, final: o, destroy: a });
      let c = i?.then;
    ...
    if (kd(e)) return Dd(ir, e, { objectMode: true, writable: false });
    if (Md(e?.readable) && Nd(e?.writable)) return ir.fromWeb(e);
    if (typeof e?.writable == "object" || typeof e?.readable == "object") {
      let i = e != null && e.readable ? Cd(e?.readable) ? e?.readable : t(e.readable) : void 0, s = e != null && e.writable ? Bd(e?.writable) ? e?.writable : t(e.writable) : void 0;
  ...
  function h0(t) {
    let { promise: e, resolve: r } = Ud(), n = new f0(), i = n.signal;
  ...
  function an(t) {
    let e = t.readable && typeof t.readable.read != "function" ? $d.wrap(t.readable) : t.readable, r = t.writable, n = !!n0(e), i = !!i0(r), s, o, a, c, f;
    function h(d) {
      let m = c;
      c = null, m ? m(d) : d && f.destroy(d);
    }
    return f = new ir({ readableObjectMode: !!(e != null && e.readableObjectMode), writableObjectMode: !!(r != null && r.writableObjectMode), readable: n, writable: i }), i && (qd(r, (d) => {
      ...
      !d && c !== null && (d = new Wd()), a = null, s = null, o = null, c === null ? m(d) : (c = m, un(r, d), un(e, d));
    }, f;
  }
});
var St = j((PC, Kd) => {
  ...
  x();
  I();
  var { ObjectDefineProperties: d0, ObjectGetOwnPropertyDescriptor: Dt, ObjectKeys: p0, ObjectSetPrototypeOf: Gd } = Ee();
  Kd.exports = ct;
  var ra = Nn(), tt = ro();
...
var so = j((iB, np) => {
  ...
  x();
  I();
  var jn = tr(), { ArrayIsArray: m0, Promise: _0, SymbolAsyncIterator: v0, SymbolDispose: S0 } = Ee(), oo = Ut(), { once: E0 } = $e(), A0 = Ar(), Zd = St(), { aggregateTwoErrors: I0, codes: { ERR_INVALID_ARG_TYPE: ga, ERR_INVALID_RETURN_VALUE: ua, ERR_MISSING_ARGS: x0, ERR_STREAM_DESTROYED: T0, ERR_STREAM_PREMATURE_CLOSE: P0 }, AbortError: O0 } = De(), { validateFunction: R0, validateAbortSignal: k0 } = Xr(), { isIterable: Pr, isReadable: la, isReadableNodeStream: io, isNodeStream: ep, isTransformStream: cn, isWebStream: C0, isReadableStream: ca, isReadableFinished: B0 } = mt(), M0 = globalThis.AbortController || Yr().AbortController, fa, ha, da;
  function tp(t, e, r) {
    let n = false;
    t.on("close", () => {
      n = true;
    ...
    for (let R = 0; R < t.length; R++) {
      ...
      if (R === 0) if (typeof T == "function") {
        ...
        if (S = T(S, { signal: i }), y) {
          ...
          S = F;
          let { destroy: Q, cleanup: W } = tp(S, false, true);
          d.push(Q), M && o.push(W);
        }
      } else if (ep(T)) {
        if (io(S)) {
...
var wa = j((pB, lp) => {
  ...
  x();
  I();
  var { pipeline: D0 } = so(), ao = St(), { destroyer: j0 } = Ar(), { isNodeStream: uo, isReadable: ip, isWritable: op, isWebStream: ba, isTransformStream: Or, isWritableStream: sp, isReadableStream: ap } = mt(), { AbortError: F0, codes: { ERR_INVALID_ARG_VALUE: up, ERR_MISSING_ARGS: W0 } } = De(), $0 = Ut();
  lp.exports = function(...e) {
    ...
    for (let g = 0; g < e.length; ++g) if (!(!uo(e[g]) && !ba(e[g]))) {
      if (g < e.length - 1 && !(ip(e[g]) || ap(e[g]) || Or(e[g]))) throw new up(`streams[${g}]`, r[g], "must be readable");
      if (g > 0 && !(op(e[g]) || sp(e[g]) || Or(e[g]))) throw new up(`streams[${g}]`, r[g], "must be writable");
    }
    let n, i, s, o, a;
    function c(g) {
      let P = o;
    ...
    let f = e[0], h = D0(e, c), d = !!(op(f) || sp(f) || Or(f)), m = !!(ip(h) || ap(h) || Or(h));
...
var mp = j((AB, va) => {
  ...
  x();
  I();
  var H0 = globalThis.AbortController || Yr().AbortController, { codes: { ERR_INVALID_ARG_VALUE: V0, ERR_INVALID_ARG_TYPE: Fn, ERR_MISSING_ARGS: G0, ERR_OUT_OF_RANGE: z0 }, AbortError: Et } = De(), { validateAbortSignal: Rr, validateInteger: cp, validateObject: kr } = Xr(), K0 = Ee().Symbol("kWeak"), Q0 = Ee().Symbol("kResistStopPropagation"), { finished: Y0 } = Ut(), J0 = wa(), { addAbortSignalNoValidate: X0 } = kn(), { isWritable: Z0, isNodeStream: eS } = mt(), { deprecate: tS } = $e(), { ArrayPrototypePush: rS, Boolean: nS, MathFloor: fp, Number: iS, NumberIsNaN: oS, Promise: hp, PromiseReject: dp, PromiseResolve: sS, PromisePrototypeThen: pp, Symbol: gp } = Ee(), lo = gp("kEmpty"), yp = gp("kEof");
  function aS(t, e) {
  ...
  function co(t, e) {
    ...
    let n = r - 1;
    return e?.highWaterMark != null && (n = fp(e.highWaterMark)), cp(r, "options.concurrency", 1), cp(n, "options.highWaterMark", 0), n += r, (async function* () {
      ...
      async function b() {
        try {
          for await (let w of o) {
            ...
            m += 1, pp(w, P, g), a.push(w), f && (f(), f = null), !d && (a.length >= n || m >= r) && await new hp((_) => {
              h = _;
            });
          }
          a.push(yp);
  ...
  function yS(t, e = void 0) {
    return e != null && kr(e, "options"), e?.signal != null && Rr(e.signal, "options.signal"), t = wp(t), (async function* () {
      var n;
  ...
  va.exports.promiseReturningOperators = { every: lS, forEach: fS, reduce: hS, toArray: dS, some: bp, find: cS };
});
var Sa = j((MB, _p) => {
  "use strict";
  A();
...
var Ea = j((HB, Op) => {
  ...
  x();
  I();
  var { Buffer: IS } = (ke(), me(qe)), { ObjectDefineProperty: Ft, ObjectKeys: Ep, ReflectApply: Ap } = Ee(), { promisify: { custom: Ip } } = $e(), { streamReturningOperators: vp, promiseReturningOperators: Sp } = mp(), { codes: { ERR_ILLEGAL_CONSTRUCTOR: xp } } = De(), xS = wa(), { setDefaultHighWaterMark: TS, getDefaultHighWaterMark: PS } = Cn(), { pipeline: Tp } = so(), { destroyer: OS } = Ar(), Pp = Ut(), Aa = Sa(), Wn = mt(), Se = Op.exports = $i().Stream;
  ...
  Ft(Tp, Ip, { __proto__: null, enumerable: true, get() {
    return Aa.pipeline;
  } });
  Ft(Pp, Ip, { __proto__: null, enumerable: true, get() {
    return Aa.finished;
  } });
  Se.Stream = Se;
...
var Bp = j((_M, Cp) => {
  ...
  x();
  I();
  var { Buffer: ft } = (ke(), me(qe)), kp = /* @__PURE__ */ Symbol.for("BufferList");
  function we(t) {
    if (!(this instanceof we)) return new we(t);
    we._init.call(this, t);
  }
  we._init = function(e) {
    Object.defineProperty(this, kp, { value: true }), this._bufs = [], this.length = 0, e && this.append(e);
  };
...
var Pa = j((YM, Lp) => {
  ...
  x();
  I();
  var K = Lp.exports, { Buffer: Ke } = (ke(), me(qe));
...
var Fp = j((g2, jp) => {
  ...
  I();
  function DS(t) {
    r.debug = r, r.default = r, r.coerce = c, r.disable = o, r.enable = i, r.enabled = a, r.humanize = Dp(), r.destroy = f, Object.keys(t).forEach((h) => {
      r[h] = t[h];
...
var Hp = j((N2, $p) => {
  ...
  x();
  I();
  var GS = Mp(), { EventEmitter: zS } = (er(), me(Zt)), Wp = qp(), pe = Pa(), ae = At()("mqtt-packet:parser"), Oa = class t extends zS {
    constructor() {
    ...
    _resetState() {
      ae("_resetState: resetting packet, error, _list, and _stateCounter"), this.packet = new Wp(), this.error = null, this._list = GS(), this._stateCounter = 0;
    }
    parse(e) {
    ...
    _newPacket() {
      return ae("_newPacket"), this.packet && (this._list.consume(this.packet.length), ae("_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d", this.packet.cmd, this.packet.payload, this.packet.length), this.emit("packet", this.packet)), ae("_newPacket: new packet"), this.packet = new Wp(), this._pos = 0, true;
    }
    _emitError(e) {
...
var Kp = j((V2, zp) => {
  ...
  x();
  I();
  var { Buffer: Hn } = (ke(), me(qe)), KS = 65536, Vp = {}, QS = Hn.isBuffer(Hn.from([1, 2]).subarray(0, 1));
  function Gp(t) {
  ...
  zp.exports = { cache: Vp, generateCache: YS, generateNumber: Gp, genBufVariableByteInt: JS, generate4ByteBuffer: XS };
});
var Qp = j((tN, Ra) => {
  "use strict";
  A();
...
var Ba = j((fN, ny) => {
  ...
  x();
  I();
  var ue = Pa(), { Buffer: se } = (ke(), me(qe)), eE = se.allocUnsafe(0), tE = se.from([0]), Vn = Kp(), rE = Qp().nextTick, rt = At()("mqtt-packet:writeToStream"), yo = Vn.cache, nE = Vn.generateNumber, iE = Vn.generateCache, ka = Vn.genBufVariableByteInt, oE = Vn.generate4ByteBuffer, He = Ca, go = true;
  function ty(t, e, r) {
  ...
  Object.defineProperty(ty, "cacheNumbers", { get() {
    return He === Ca;
  }, set(t) {
  ...
  function aE(t, e, r) {
    ...
    let b = false;
    if (h != null) if (ey(h)) b = true, g += se.byteLength(h) + 2;
  ...
  function lE(t, e, r) {
    ...
    return e.write(ue.PUBLISH_HEADER[s][i.dup ? 1 : 0][o ? 1 : 0]), nt(e, d), He(e, ry(a)), e.write(a), s > 0 && He(e, f), m?.write(), rt("publish: payload: %o", c), e.write(c);
  }
  function cE(t, e, r) {
  ...
  function nt(t, e) {
    ...
    let r = Yp[e];
    return r || (r = ka(e), e < 16384 && (Yp[e] = r)), rt("writeVarByteInt: writing to stream: %o", r), t.write(r);
  }
  function Br(t, e) {
      ...
      case "pair": {
        Object.getOwnPropertyNames(r).forEach((i) => {
          ...
          Array.isArray(s) ? s.forEach((o) => {
            t.write(se.from([ue.properties[e]])), Jp(t, i.toString(), o.toString());
          }) : (t.write(se.from([ue.properties[e]])), Jp(t, i.toString(), s.toString()));
        });
        break;
      }
      default:
  ...
  function Zp(t, e, r) {
    ...
    for (let n in e) if (Object.prototype.hasOwnProperty.call(e, n) && e[n] != null) {
      let i = e[n];
      if (Array.isArray(i)) for (let s = 0; s < i.length; s++) Xp(t, n, i[s]);
      else Xp(t, n, i);
    }
  }
  function ry(t) {
...
var sy = j((vN, oy) => {
  ...
  x();
  I();
  var _E = Ba(), { EventEmitter: vE } = (er(), me(Zt)), { Buffer: iy } = (ke(), me(qe));
  function SE(t, e) {
    let r = new Ma();
  ...
  var Ma = class extends vE {
    ...
    concat() {
      ...
      for (s = 0; s < n.length && n[s] !== void 0; s++) typeof n[s] != "string" ? r[s] = n[s].length : r[s] = iy.byteLength(n[s]), e += r[s];
...
var py = j((Da) => {
  ...
  var dy = [0, 16, 128, 131, 135, 144, 145, 151, 153], OE = (t, e, r) => {
    ...
    switch (t.log("handlePublish: qos %d", s), s) {
      case 2: {
        a.customHandleAcks(n, i, e, (c, f) => {
          ...
          if (dy.indexOf(f) === -1) return t.emit("error", new Error("Wrong reason code for pubrec"));
      ...
      case 1: {
        a.customHandleAcks(n, i, e, (c, f) => {
          if (typeof c == "number" && (f = c, c = null), c) return t.emit("error", c);
          if (dy.indexOf(f) === -1) return t.emit("error", new Error("Wrong reason code for puback"));
...
var zn = j((ur) => {
  ...
  var CE = (t, e) => {
    ...
    switch (t.log("_handleAck :: packet type", n), n) {
      ...
      case "puback": {
        let a = e.reasonCode;
        a && a > 0 && a !== 16 ? (o = new gy.ErrorWithReasonCode(`Publish error: ${ur.ReasonCodes[a]}`, a), t._removeOutgoingAndStoreMessage(r, () => {
          s(o, e);
...
var wy = j((Wa) => {
  ...
  var by = Mr(), BE = zn(), ME = (t, e) => {
    let { options: r } = t, n = r.protocolVersion, i = n === 5 ? e.reasonCode : e.returnCode;
    if (n !== 5) {
      let s = new by.ErrorWithReasonCode(`Protocol error: Auth packets are only supported in MQTT 5. Your version:${n}`, i);
      t.emit("error", s);
      return;
    }
    t.handleAuth(e, (s, o) => {
      ...
      if (i === 24) t.reconnecting = false, t._sendPacket(o);
        ...
        let a = new by.ErrorWithReasonCode(`Connection refused: ${BE.ReasonCodes[i]}`, i);
        t.emit("error", a);
      }
    });
  };
...
var Ey = j((_o) => {
  ...
  _o.LRUCache = void 0;
  var gn = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, _y = /* @__PURE__ */ new Set(), $a = typeof N == "object" && N ? N : {}, vy = (t, e, r, n) => {
    typeof $a.emitWarning == "function" ? $a.emitWarning(t, e, r, n) : console.error(`[${r}] ${e}: ${t}`);
  }, mo = globalThis.AbortController, my = globalThis.AbortSignal;
  if (typeof mo > "u") {
    my = class {
      onabort;
      _onabort = [];
    ...
    let t = $a.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1", e = () => {
      t && (t = false, vy("AbortController is not defined. If using lru-cache in node 14, load an AbortController polyfill from the `node-abort-controller` package. A minimal polyfill is provided for use by LRUCache.fetch(), but it should not be relied upon in other contexts (eg, passing it to other APIs that use AbortController/AbortSignal might have undesirable effects). You may disable this with LRU_CACHE_IGNORE_AC_WARNING=1 in the env.", "NO_ABORT_CONTROLLER", "ENOTSUP", e));
    };
  }
  var NE = (t) => !_y.has(t), gL = /* @__PURE__ */ Symbol("type"), lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), Sy = (t) => lr(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? bn : null : null, bn = class extends Array {
    constructor(e) {
      super(e), this.fill(0);
    }
  }, Ha = class t {
    ...
    constructor(e) {
      ...
      if (!this.ttlAutopurge && !this.#u && !this.#f) {
        ...
        NE(M) && (_y.add(M), vy("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", M, t));
      }
    }
    getRemainingTTL(e) {
...
var su = j((Bo) => {
  ...
  Bo.default = void 0;
  var ky = Ry(), i1 = It(), Cy = xt(), ou = class extends i1.Container {
    constructor(e = function(n, i) {
      return n < i ? -1 : n > i ? 1 : 0;
    }, r = false) {
      super(), this.Y = void 0, this.v = e, r ? (this.re = ky.TreeNodeEnableIndex, this.M = function(n, i, s) {
        let o = this.ne(n, i, s);
        if (o) {
          let a = o.tt;
      ...
      }) : (this.re = ky.TreeNode, this.M = function(n, i, s) {
        let o = this.ne(n, i, s);
    ...
    updateKeyByIterator(e, r) {
      let n = e.o;
      if (n === this.h && (0, Cy.throwIteratorAccessError)(), this.i === 1) return n.u = r, true;
...
var Dy = j((Uo) => {
  ...
  Uo.default = void 0;
  var Uy = gu(), w1 = xt(), Dr = class t extends Uy.HashContainerIterator {
    constructor(e, r, n, i) {
      super(e, r, i), this.container = n;
    }
    get pointer() {
...
var Wy = j((it) => {
  ...
  var A1 = Tt(Ay()), I1 = Tt(Iy()), x1 = Tt(xy()), T1 = Tt(Ty()), P1 = Tt(Py()), O1 = Tt(Oy()), R1 = Tt(My()), k1 = Tt(qy()), C1 = Tt(Dy()), B1 = Tt(Fy());
  function Tt(t) {
    return t && t.t ? t : { default: t };
  }
});
var Hy = j((fj, $y) => {
  ...
  x();
  I();
  var M1 = Wy().OrderedSet, Pt = At()("number-allocator:trace"), N1 = At()("number-allocator:error");
  function Ve(t, e) {
...
var zy = j((Qn) => {
  ...
  var j1 = zn(), F1 = D1(Gy()), W1 = Mr(), $1 = (t, e) => {
...
var Qy = j((Yn) => {
  ...
  var V1 = Jn(py()), G1 = Jn(wy()), z1 = Jn(zy()), K1 = Jn(zn()), Q1 = Jn(Ky()), Y1 = (t, e, r) => {
    let { options: n } = t;
...
var Pu = j((Fo, Xy) => {
  ...
  I();
  (function(t, e) {
    typeof Fo == "object" && typeof Xy < "u" ? e(Fo) : typeof define == "function" && define.amd ? define(["exports"], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.fastUniqueNumbers = {}));
  })(Fo, (function(t) {
    "use strict";
    var e = function(m) {
      return function(g) {
...
var ag = j((w6, oi) => {
  ...
  function lA(t, e) {
    if (t) {
      ...
      return r === "Object" && t.constructor && (r = t.constructor.name), r === "Map" || r === "Set" ? Array.from(t) : r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? sg(t, e) : void 0;
    }
  }
...
var Cu = j((AW, Ht) => {
  ...
  function hg() {
    ...
    }), (Ht.exports = hg = function() {
      return { w: s, m };
    }, Ht.exports.__esModule = true, Ht.exports.default = Ht.exports)();
  }
  Ht.exports = hg, Ht.exports.__esModule = true, Ht.exports.default = Ht.exports;
});
var Nu = j((MW, ci) => {
  A();
  x();
...
var bg = j((R4, Vt) => {
  ...
  x();
  I();
  var TA = Ru(), PA = Cu(), OA = dg(), RA = qu(), kA = Nu(), CA = pg(), gg = yg();
  function Lu() {
    "use strict";
...
var vg = j((Ho, _g) => {
  ...
  I();
  (function(t, e) {
    typeof Ho == "object" && typeof _g < "u" ? e(Ho, Pu(), rg(), lg(), fg(), mg()) : typeof define == "function" && define.amd ? define(["exports", "fast-unique-numbers", "@babel/runtime/helpers/defineProperty", "@babel/runtime/helpers/slicedToArray", "@babel/runtime/helpers/asyncToGenerator", "@babel/runtime/regenerator"], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.brokerFactory = {}, t.fastUniqueNumbers, t._defineProperty, t._slicedToArray, t._asyncToGenerator, t._regeneratorRuntime));
...
var Eg = j((Vo, Sg) => {
  ...
  I();
  (function(t, e) {
    typeof Vo == "object" && typeof Sg < "u" ? e(Vo, vg(), Pu(), Xn()) : typeof define == "function" && define.amd ? define(["exports", "broker-factory", "fast-unique-numbers", "@babel/runtime/helpers/typeof"], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.workerTimersBroker = {}, t.brokerFactory, t.fastUniqueNumbers, t._typeof));
  })(Vo, (function(t, e, r, n) {
    "use strict";
    var i = function(w) {
      return function(_) {
...
var Ig = j((Go, Ag) => {
  ...
  I();
  (function(t, e) {
    typeof Go == "object" && typeof Ag < "u" ? e(Go, Eg()) : typeof define == "function" && define.amd ? define(["exports", "worker-timers-broker"], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.workerTimers = {}, t.workerTimersBroker));
  })(Go, (function(t, e) {
    "use strict";
    var r = function(h, d) {
      var m = null;
...
var yi = j((Fr) => {
  ...
  var BA = () => typeof window < "u" ? typeof navigator < "u" && navigator.userAgent?.toLowerCase().indexOf(" electron/") > -1 && N?.versions ? !Object.prototype.hasOwnProperty.call(N.versions, "electron") : typeof window.document < "u" : false, xg = () => !!(typeof self == "object" && self?.constructor?.name?.includes("WorkerGlobalScope") && typeof Deno > "u"), Tg = () => typeof navigator < "u" && navigator.product === "ReactNative", MA = BA() || xg() || Tg();
  Fr.isWebWorker = xg();
...
var kg = j((Gt) => {
  ...
  var Pg = Ig(), Uu = LA(yi()), Og = { set: Pg.setInterval, clear: Pg.clearInterval }, Rg = { set: (t, e) => setInterval(t, e), clear: (t) => clearInterval(t) }, UA = (t) => {
    switch (t) {
      case "native":
        return Rg;
      case "worker":
      ...
      case "auto":
      default:
        return Uu.default && !Uu.isWebWorker && !Uu.isReactNativeBrowser ? Og : Rg;
    }
  };
  Gt.default = UA;
});
...
var zo = j((yt) => {
  ...
  var FA = yt && yt.__createBinding || (Object.create ? (function(t, e, r, n) {
    ...
    t.default = e;
  }), qg = yt && yt.__importStar || /* @__PURE__ */ (function() {
    var t = function(e) {
      return t = Object.getOwnPropertyNames || function(r) {
        var n = [];
        for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
  ...
  var Fu = fr(ay()), $A = or(), Cg = fr(fy()), HA = fr(At()), Bg = qg(Na()), vn = fr(Ua()), VA = fr(Qy()), GA = fr(Iu()), zA = fr(Yy()), bi = Mr(), KA = Jy(), QA = fr(ju()), Mg = qg(yi()), Wu = globalThis.setImmediate || ((...t) => {
    let e = t.shift();
    (0, bi.nextTick)(() => {
      e(...t);
    });
  }), Ng = { keepalive: 60, reschedulePings: true, protocolId: "MQTT", protocolVersion: 4, reconnectPeriod: 1e3, connectTimeout: 30 * 1e3, clean: true, resubscribe: true, subscribeBatchSize: null, writeCache: true, timerVariant: "auto" }, $u = class t extends KA.TypedEventEmitter {
    ...
    constructor(e, r) {
      ...
      for (let n in Ng) typeof this.options[n] > "u" ? this.options[n] = Ng[n] : this.options[n] = r[n];
      this.log = this.options.log || (0, HA.default)("mqttjs:client"), this.noop = this._noop.bind(this), this.log("MqttClient :: version:", t.VERSION), Mg.isWebWorker ? this.log("MqttClient :: environment", "webworker") : this.log("MqttClient :: environment", Mg.default ? "browser" : "node"), this.log("MqttClient :: options.protocol", r.protocol), this.log("MqttClient :: options.protocolVersion", r.protocolVersion), this.log("MqttClient :: options.username", r.username), this.log("MqttClient :: options.keepalive", r.keepalive), this.log("MqttClient :: options.reconnectPeriod", r.reconnectPeriod), this.log("MqttClient :: options.rejectUnauthorized", r.rejectUnauthorized), this.log("MqttClient :: options.properties.topicAliasMaximum", r.properties ? r.properties.topicAliasMaximum : void 0), this.options.clientId = typeof r.clientId == "string" ? r.clientId : t.defaultId(), this.log("MqttClient :: clientId", this.options.clientId), this.options.customHandleAcks = r.protocolVersion === 5 && r.customHandleAcks ? r.customHandleAcks : (...n) => {
        n[3](null, 0);
    ...
    _storeAndSend(e, r, n) {
      ...
      let i = e, s;
      if (i.cmd === "publish" && (i = (0, Cg.default)(e), s = this._removeTopicAliasAndRecoverTopicName(i), s)) return r && r(s);
...
var Dg = ze(() => {
  ...
  I();
  Gu = {}, Ug = false;
  hr = JA(), m5 = hr.decode, _5 = hr.encode, v5 = hr.toASCII, S5 = hr.toUnicode, E5 = hr.ucs2, A5 = hr.version;
});
function XA() {
  return jg || (jg = true, zu = function() {
...
function ZA() {
  return Fg || (Fg = true, Ku = Error), Ku;
}
function eI() {
  return Wg || (Wg = true, Qu = EvalError), Qu;
}
function tI() {
  return $g || ($g = true, Yu = RangeError), Yu;
}
function rI() {
  return Hg || (Hg = true, Ju = ReferenceError), Ju;
}
function ab() {
  return Vg || (Vg = true, Xu = SyntaxError), Xu;
}
function Sn() {
  return Gg || (Gg = true, Zu = TypeError), Zu;
}
function nI() {
  return zg || (zg = true, el = URIError), el;
}
function iI() {
  if (Kg) return tl;
  Kg = true;
...
function Wr() {
  if (Zg) return sl;
  Zg = true;
  var t, e = ZA(), r = eI(), n = tI(), i = rI(), s = ab(), o = Sn(), a = nI(), c = Function, f = function(G) {
    try {
...
function cI() {
  if (ib) return fl;
  ib = true;
  var t = Wr(), e = uI(), r = lI()(), n = ub(), i = Sn(), s = t("%Math.floor%");
...
function hI() {
  !En || !$r || (En = false, $r.length ? zt = $r.concat(zt) : Ko = -1, zt.length && fb());
}
function fb() {
  if (!En) {
...
var xb = {};
Kr(xb, { URL: () => jx, Url: () => Nx, default: () => Ge, fileURLToPath: () => Ab, format: () => qx, parse: () => Dx, pathToFileURL: () => Ib, resolve: () => Lx, resolveObject: () => Ux });
function Px() {
  if (yb) return Al;
  yb = true;
  ...
  Al = function k(B, re, ie, oe) {
    ...
    function ut(zr, Ti, Qb) {
      if (Ti && (oe = F.call(oe), oe.push(Ti)), Qb) {
        ...
        return Re(fe, "quoteStyle") && (sc.quoteStyle = fe.quoteStyle), k(zr, sc, ie + 1, oe);
      }
      return k(zr, fe, ie + 1, oe);
    }
    if (typeof B == "function" && !be(B)) {
      var Zl = Ct(B), ec = $(B, ut);
      return "[Function" + (Zl ? ": " + Zl : " (anonymous)") + "]" + (ec.length > 0 ? " { " + M.call(ec, ", ") + " }" : "");
    }
    if (Oe(B)) {
      var tc = z ? R.call(String(B), /^(Symbol\(.*\))_[^)]*$/, "$1") : H.call(B);
    ...
    if (!he(B) && !be(B)) {
      var is = $(B, ut), ic = G ? G(B) === Object.prototype : B instanceof Object || B.constructor === Object, os = B instanceof Object ? "" : "null prototype", oc = !ic && J && Object(B) === B && J in B ? _.call(Ne(B), 8, -1) : os ? "Object" : "", Kb = ic || typeof B.constructor != "function" ? "" : B.constructor.name ? B.constructor.name + " " : "", ss = Kb + (oc || os ? "[" + M.call(v.call([], oc || [], os || []), ": ") + "] " : "");
...
function Ox() {
  if (gb) return xl;
  gb = true;
  var t = Wr(), e = lb(), r = Px(), n = Sn(), i = t("%WeakMap%", true), s = t("%Map%", true), o = e("WeakMap.prototype.get", true), a = e("WeakMap.prototype.set", true), c = e("WeakMap.prototype.has", true), f = e("Map.prototype.get", true), h = e("Map.prototype.set", true), d = e("Map.prototype.has", true), m = function(b, w) {
...
function Rx() {
  if (mb) return Ol;
  mb = true;
  var t = Ox(), e = Eb(), r = Bl(), n = Object.prototype.hasOwnProperty, i = { brackets: function(b) {
    return b + "[]";
...
var Tb = ze(() => {
  ...
  pb();
  vl();
  Tx = Object.freeze(/* @__PURE__ */ Object.create(null)), Al = {}, yb = false, Il = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : global;
  xl = {}, gb = false;
  Tl = {}, bb = false;
  Pl = {}, wb = false;
  Ol = {}, mb = false;
...
var Qo = j((mi) => {
  ...
  mi.writev = kb;
  var Zx = or(), Rb = (ke(), me(qe));
  function kb(t, e) {
    let r = new Array(t.length);
    for (let n = 0; n < t.length; n++) typeof t[n].chunk == "string" ? r[n] = Rb.Buffer.from(t[n].chunk, "utf8") : r[n] = t[n].chunk;
  ...
  var Ml = class extends Zx.Duplex {
    ...
    writeQueue;
    constructor(e, r, n) {
      super({ objectMode: true }), this.proxy = r, this.socket = n, this.writeQueue = [], e.objectMode || (this._writev = kb.bind(this)), this.isSocketOpen = false, this.proxy.on("data", (i) => {
...
var _i = j((gr) => {
  ...
  var Yo = (ke(), me(qe)), Cb = ql(Ob()), eT = ql(At()), tT = or(), rT = ql(yi()), Nl = Qo(), yr = (0, eT.default)("mqttjs:ws"), nT = ["rejectUnauthorized", "ca", "cert", "key", "pfx", "passphrase"];
  function Bb(t, e) {
  ...
  function oT(t, e, r) {
    ...
    let i;
    return r.createWebsocket ? i = r.createWebsocket(e, [n], r) : i = new Cb.default(e, [n], r.wsOptions), i;
  }
  function sT(t, e) {
    let r = e.protocolId === "MQIsdp" && e.protocolVersion === 3 ? "mqttv3.1" : "mqtt", n = Bb(e, t), i;
  ...
  var aT = (t, e) => {
    ...
    let n = Bb(r, t), i = oT(t, n, r), s = Cb.default.createWebSocketStream(i, r.wsOptions);
...
var $l = j((Si) => {
  ...
  var Ub = (Lb(), me(qb)), gT = Wl((Ul(), me(Ll))), bT = Wl(At()), wT = Wl(Dl()), mT = (0, bT.default)("mqttjs:tls");
  function _T(t) {
  ...
  var vT = (t, e) => {
    e.port = e.port || 8883, e.host = e.hostname || e.host || "localhost", gT.default.isIP(e.host) === 0 && !e.servername && (e.servername = e.host), e.rejectUnauthorized = e.rejectUnauthorized !== false, delete e.path, mT("port %d host %s rejectUnauthorized %b", e.port, e.host, e.rejectUnauthorized);
    let r = _T(e);
    r.on("secureConnect", () => {
...
var Gl = j((Vl) => {
  ...
  var Db = (ke(), me(qe)), ST = or(), ET = Qo(), kt, Hl, Xe;
  function AT() {
  ...
  function TT() {
    kt.onOpen(() => {
      ...
      let { data: e } = t;
      e instanceof ArrayBuffer ? e = Db.Buffer.from(e) : e = Db.Buffer.from(e, "utf8"), Hl.push(e);
    }), kt.onClose(() => {
...
var Ql = j((Kl) => {
  ...
  var zl = (ke(), me(qe)), OT = or(), RT = Qo(), Kt, Ei, An, jb = false;
  function kT() {
...
var $b = j((In) => {
  ...
  In.connectAsync = FT;
  var qT = Jo(At()), LT = Jo((Tb(), me(xb))), UT = Jo(zo()), Yl = Jo(yi());
  ...
  function Wb(t, e) {
    if (Fb("connecting to an MQTT broker..."), typeof t == "object" && !e && (e = t, t = ""), e = e || {}, t && typeof t == "string") {
      let i = LT.default.parse(t, true), s = {}, o = !i.protocol && !i.hostname && i.path?.startsWith("/") && (Yl.default || e.forceNativeWebSocket);
      if (i.port != null && (s.port = Number(i.port)), s.host = i.hostname, s.query = i.query, s.auth = i.auth, s.protocol = i.protocol, s.path = i.path, e = { ...s, ...e }, !e.protocol && !o) throw new Error("Missing protocol");
      e.protocol = (e.protocol || DT()).replace(/:$/, "");
    }
    if (e.unixSocket = e.unixSocket || e.protocol?.includes("+unix"), e.unixSocket ? e.protocol = e.protocol.replace("+unix", "") : !e.protocol?.startsWith("ws") && !e.protocol?.startsWith("wx") && delete e.path, jT(e), e.query && typeof e.query.clientId == "string" && (e.clientId = e.query.clientId), Yl.default || e.unixSocket ? e.socksProxy = void 0 : e.socksProxy === void 0 && typeof N < "u" && (e.socksProxy = N.env.MQTTJS_SOCKS_PROXY), e.cert && e.key) if (e.protocol) {
...
var Xl = j((ge) => {
  ...
  var Hb = ge && ge.__createBinding || (Object.create ? (function(t, e, r, n) {
    ...
    n === void 0 && (n = r), t[n] = e[r];
  })), WT = ge && ge.__setModuleDefault || (Object.create ? (function(t, e) {
    Object.defineProperty(t, "default", { enumerable: true, value: e });
  }) : function(t, e) {
    t.default = e;
  }), $T = ge && ge.__importStar || /* @__PURE__ */ (function() {
    var t = function(e) {
      return t = Object.getOwnPropertyNames || function(r) {
        var n = [];
        for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
  ...
  })(), Jl = ge && ge.__exportStar || function(t, e) {
...
var ZT = j((ot) => {
  ...
  var zb = ot && ot.__createBinding || (Object.create ? (function(t, e, r, n) {
    ...
    n === void 0 && (n = r), t[n] = e[r];
  })), QT = ot && ot.__setModuleDefault || (Object.create ? (function(t, e) {
    Object.defineProperty(t, "default", { enumerable: true, value: e });
  }) : function(t, e) {
    t.default = e;
  }), YT = ot && ot.__importStar || /* @__PURE__ */ (function() {
    var t = function(e) {
      return t = Object.getOwnPropertyNames || function(r) {
        var n = [];
        for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
  ...
  })(), JT = ot && ot.__exportStar || function(t, e) {
...
// web/node_modules/.pnpm/trystero@0.21.8_patch_hash=0f996a67be939374c9fb8781108d984800a87165aa5490f6091c582d151f_286f6546a6b71589aa8b66317ea7a1bd/node_modules/trystero/src/mqtt.js
var sockets = {};
var defaultRedundancy = 4;
var msgHandlers = {};
var getClientId = ({ options }) => options.host + options.path;
var joinRoom = strategy_default({
  init: (config) => getRelays(config, defaultRelayUrls, defaultRedundancy).map((url) => {
    const client = mqtt_esm_default.connect(url);
    const clientId = getClientId(client);
    sockets[clientId] = client.stream.socket;
    msgHandlers[clientId] = {};
    client.on(
      "message",
      (topic, buffer) => msgHandlers[clientId][topic]?.(topic, buffer.toString())
    ).on("error", (err) => console.error(err));
    return new Promise((res) => client.on("connect", () => res(client)));
  }),
  subscribe: (client, rootTopic, selfTopic, onMessage) => {
    const clientId = getClientId(client);
    msgHandlers[clientId][rootTopic] = msgHandlers[clientId][selfTopic] = (topic, data) => onMessage(topic, data, client.publish.bind(client));
...
//# sourceMappingURL=trystero_mqtt.js.map
